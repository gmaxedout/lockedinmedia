...
export const BullseyeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v-3m0 18v-3m-6.75-6.75h-3m18 0h-3" />
    </svg>
);

export const CropIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75v12.75m0-12.75h12.75m-12.75 0H3.75m16.5 0v12.75m0-12.75v-1.5a2.25 2.25 0 0 0-2.25-2.25H3.75a2.25 2.25 0 0 0-2.25 2.25v1.5m0 12.75v1.5a2.25 2.25 0 0 0 2.25 2.25h1.5m12.75 0h1.5a2.25 2.25 0 0 0 2.25-2.25v-1.5" />
    </svg>
);